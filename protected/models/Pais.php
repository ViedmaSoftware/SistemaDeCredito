...
class Pais extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('codigo_telefono, codigo_postal', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nombre, codigo_telefono, codigo_postal', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'provincias' => array(self::HAS_MANY, 'Provincia', 'id_pais'),
		);
	}
