...
class CrugeUi extends CComponent
{
    ...
    */
    ...
    {
        return array(
            array('label' => CrugeTranslator::t('admin', 'Administración de Usuarios')),
            array(
            ...
            array('label' => CrugeTranslator::t('admin', 'Personalizados de Campos')),
            array(
                'label' => CrugeTranslator::t('admin', 'Listar los Campos')
            ,
                'url' => $this->getFieldsAdminListUrl()
            ),
            array(
                'label' => CrugeTranslator::t('admin', 'Crear Campos')
            ,
            ...
            array(
                'label' => CrugeTranslator::t('admin', 'Assiganacion de Roles a Usuarios')
            ,
            ...
            array(
                'label' => CrugeTranslator::t('admin', 'Variables de Sistemas')
            ,
