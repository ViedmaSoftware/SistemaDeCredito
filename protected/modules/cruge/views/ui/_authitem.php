...
<div class='row-fluid' <?php echo $colorEspecialBkTaskTipoMenuitem;?> >
	...
	<div class='row-fluid span12 col authname'><?php echo $data->name;?></div>
	
	
	<div class='span2 operacion'>
	...
	<div class='span3 operacion operacion-eliminar'>
		<?php 
			$url = '#';
